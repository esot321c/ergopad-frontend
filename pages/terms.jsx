    ...
    <>
        <Container maxWidth="760px" sx={{ maxWidth: '760px', mx: 'auto' }}>
            ...
            <Typography variant="p">
                ...
                <Typography variant="p" sx={{ ml: '3rem' }}>1. Your use or any person using the Services on your behalf or participation in accordance with the Services on the Website or the ADAPAD Platform;
                </Typography>
